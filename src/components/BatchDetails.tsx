    ...
    >
      <Card containerStyle={cardStyle.container} key={index}>
        <View style={cardStyle.row}>
          ...
          <View style={{marginStart: 12, width: '73%'}}>
            <View style={[cardStyle.j_row]}>
              ...
              <Ionicons name="checkmark-circle" size={20} color={'#124076'} />
            </View>
            <View style={cardStyle.row}>
              <Ionicons name="location-sharp" size={14} color={'#124076'} />
              <Text style={cardStyle.subTitle}>{item?.address}</Text>
            </View>
            <View style={cardStyle.row}>
              <Icon name="phone-alt" size={13} color={'#124076'} />
        ...
        <View style={[cardStyle.j_row, {marginTop: 10}]}>
          <View style={cardStyle.row}>
            <Icon name="history" size={14} color={'#124076'} />
            <Text style={cardStyle.subTitle}>Att. History</Text>
          </View>
          <View style={cardStyle.row}>
            <Ionicons name="person" size={14} color={'#124076'} />
            <Text style={cardStyle.subTitle}>Profile</Text>
          </View>
          <View style={cardStyle.row}>
            <Ionicons name="chatbubble" size={14} color={'#124076'} />
