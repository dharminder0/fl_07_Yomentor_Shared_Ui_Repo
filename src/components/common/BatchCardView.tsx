      ...
      <Card containerStyle={cardStyle.container} key={index}>
        ...
        <View style={cardStyle.j_row}>
          <View style={cardStyle.row3}>
            <Icon name="laptop" size={14} color={'#124076'} />
          ...
          <View style={cardStyle.row3}>
            <Icon name="money-bill-wave" size={14} color={'#124076'} />
        ...
        <View style={cardStyle.j_row}>
          <View style={cardStyle.row3}>
            <Icon name="book" size={14} color={'#124076'} />
            <Text style={cardStyle.subTitle}>{item?.subjectName}</Text>
          </View>
          <View style={cardStyle.row3}>
            <Icon name="calendar-day" size={14} color={'#124076'} />
